...
| ´Metadata´ | This represents a dictionary of metadata that supports the following values:
patientportal→ for the Patient Portal
enterpriseportal→ for the Enterprise Portal
healthcareportal→ for the Healthcare Portal |
